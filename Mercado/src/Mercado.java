	...
	public static void main(String[] args) {
		...
		do {
			...
			case 4:
				...
				System.out.println("Numero : " + nfiscal1.numero_nfe);
				System.out.println("Data :"  + nfiscal1.data_nfe);
				System.out.println(" Cliente codigo " + nfiscal1.clientedanota.codigo_cliente);
				System.out.println("Cliente nome :" + nfiscal1.clientedanota.nome_cliente);
				System.out.println("Cliente endereco :" + nfiscal1.clientedanota.endereco_cliente);
				System.out.println("=== = === ");
